...
// //handle edit jobs
// // document.addEventListener("click", async (e)=>{
// //   if(e.target.classList.constains("edit-job")) {
// //     const jobId = e.target.dataset.id;

// //     if(!confirm("Are you sure you want to Edit this job?")) return;

// //     try{
// //       const res = await fetch(`${API}/jobs/bob/${jobId}/edit/`)
// //     }
// //   }
// // });
...
function editJob(jobId) {
  // Pass the job ID as a URL parameter to the post-job page
